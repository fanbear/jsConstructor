...
var model = [{
  ...
  type: 'columns',
  value: ['Первая строка колонки', 'Вторая строка колонки', 'Третая строка колонки'],
  options: {
    styles: {
...
var title = function title(block) {
...
_model.default.forEach(function (block) {
